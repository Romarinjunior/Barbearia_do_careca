...
<style>
  body {
    ...
    color: #ffffff;
    background-image: linear-gradient(170deg, rgb(0, 0, 0), white);
  }
  .botao {
  margin-left: auto; 
  display: block;   
...
<div class="container mt-3">
  ...
  <form action="DadosFormulario.php" method="POST">
    <div class="mb-3 mt-3">
      ...
      <input id="nome" name="nome" class="form-control" value="" type="text">
    </div>
    <div class="mb-3 mt-3">
      <label for="email">Email:</label>
      <input id="email" name="email" class="form-control" value="" type="email">
    </div>
    <div class="mb-3 mt-3">
      <label for="data_de_nascimento">Data de Nascimento:</label>
      <input id="data_de_nascimento" name="data_de_nascimento" class="form-control" value="" type="date">
    </div>
    <div class="mb-3 mt-3">
    ...
    <div class="mb-3 mt-3">
      ...
      <select id="nome_banco" name="nome_banco" class="form-control">
      </select>
    </div>
    <div class="mb-3 mt-3">
      <label for="numero_agencia">Número da Agência:</label>
      <input id="numero_agencia" name="numero_agencia" class="form-control" value="">
    </div>
    <div class="mb-3 mt-3">
      <label for="numero_conta">Número da Conta:</label>
      <input id="numero_conta" name="numero_conta" class="form-control" value="">
    </div>
    <div class="mb-3 mt-3">
      <label for="chave_pix">Chave Pix:</label>
      <input id="chave_pix" name="chave_pix" class="form-control" value="">
    </div>
